...
def main():
    ...
    report.append("## Notes")
    report.append("")
    report.append("- **PRs**: Merged pull requests to github.com/plone/volto (does not include open or closed/rejected PRs)")
    report.append("- **Commits**: Direct commits to github.com/plone/volto")
