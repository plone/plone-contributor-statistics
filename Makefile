...
help:
	...
	@echo "  generate-plip-report Generate PLIP contribution report"
...
# Generate PLIP contribution report
generate-plip-report:
	python generate_plip_report.py
