...
help:
	...
	@echo "  active-github-users Extract active GitHub users from the last 3 years"
...
run-stats-2026:
	python plone_contributors.py --year 2026
...
# Extract active GitHub users from the last 3 completed years
active-github-users:
