...
help:
	...
	@echo "  community-recognition Calculate community recognition points (community activities only)"
	@echo "  code-recognition  Calculate code recognition tiers for organisations and individuals"
...
# Calculate community recognition points and generate report (community activities only)
community-recognition:
	python generate_community_recognition_report.py

# Calculate code recognition tiers for organisations and individuals (PRs + PLIPs)
code-recognition:
